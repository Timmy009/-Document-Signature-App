...
var FileContentGenerator = /** @class */ (function () {
    ...
    function FileContentGenerator(generatedClassnames, configParser) {
        ...
        this.utilityFunctionsTemplate = function () {
            ...
            for (var _i = 0, _a = Object.entries(_this._generatedClassNames); _i < _a.length; _i++) {
                ...
                var subCategoriesTemplate = Object.keys(value) // sub-ctegories keys
                    ...
                    var fnName = lodash_1.default.camelCase(SubCategory);
                    var fnType = "TUtilityFunction<T".concat(lodash_1.default.upperFirst(SubCategory), ">");
                    return "export const ".concat(fnName, ": ").concat(fnType, " = classnamesLib as any");
                })
                    .join('\n');
                template =
                    template +
                        '\n' +
                        "\n//////////// ".concat(categoryKey, " Utility functions\n") +
                        '\n' +
             ...
             */
            var generalCategoriesTemplate = Object.keys(_this._generatedClassNames)
                .map(function (categorykey) {
                var comment = '\n' + "\n//////////// ".concat(categorykey, " Utility functions\n") + '\n';
                var fnName = lodash_1.default.camelCase(categorykey);
                var fnType = "TUtilityFunction<T".concat(lodash_1.default.upperFirst(categorykey), ">");
                return comment + "export const ".concat(fnName, ": ").concat(fnType, " = classnamesLib as any");
            })
                .join('\n');
        ...
        this.mainExportStatementsTemplate = function () {
            var specificUtilityFunctionsObjectTemplate = Object.keys(_this._generatedClassNames)
                .map(function (cn) {
                ...
                .join(',\n');
            var generalUtilityFunctionsObjectTemplate = Object.keys(_this._generatedClassNames)
                .map(function (cn) { return '  ' + lodash_1.default.camelCase(cn); })
                .join(',\n');
            return ("export const TW = {\n".concat(specificUtilityFunctionsObjectTemplate, "\n}\n") +
                '\n' +
                "export const CN = {\n".concat(generalUtilityFunctionsObjectTemplate, "\n}\n") +
                '\n' +
                ...
                '| null\n' +
                '| undefined\n' +
                _this.getDarkModeClassnameType() +
         ...
         */
        this.getDarkModeClassnameType = function () {
            var darkModeConfig = _this._configParser.getDarkMode();
            if (lodash_1.default.isArray(darkModeConfig) && darkModeConfig[0] === 'class') {
                return "| '".concat(darkModeConfig[1], "'\n");
            }
            else if (lodash_1.default.isString(darkModeConfig) && darkModeConfig === 'class') {
                return "| 'dark'\n";
            }
            else {
                return '';
        ...
        this.generateTypesGroupTemplate = function (group, groupName) {
            ...
            var generateGroupStatement = function () {
                ...
                return ("export type T".concat(lodash_1.default.upperFirst(groupName), " =") +
                    '\n  | ' +
        ...
        this.generateTypesTemplate = function (typeName, items, prefix, surroundWithQuotes) {
            ...
            return ("export type T".concat(lodash_1.default.upperFirst(typeName), " =") +
                '\n  | ' +
                items
                    ...
                    return classnamesThatShouldKeepTheDefaultSuffix.map(function (x) {
                        ...
                        var nameWithOrWithoutPrefix = "".concat(prefix ? prefix : '').concat(name);
                        return surroundWithQuotes ? "'".concat(nameWithOrWithoutPrefix, "'") : nameWithOrWithoutPrefix;
                    });
                })
                    .join('\n  | '));
        };
