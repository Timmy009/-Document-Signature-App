...
var ClassnamesGenerator = /** @class */ (function () {
    ...
    function ClassnamesGenerator(parser) {
            ...
            return tslib_1.__assign(tslib_1.__assign({}, non_configurable_1.nonConfigurableClassNames.layout), { objectPosition: Object.keys(_this._theme.objectPosition).map(function (x) { return 'object-' + x; }), inset: Object.keys(_this._theme.inset).flatMap(function (insetValue) {
                    return ['inset', 'inset-x', 'inset-y', 'top', 'right', 'bottom', 'left'].map(function (side) {
                        return insetValue.startsWith('-')
                            ? "-".concat(side, "-").concat(insetValue.substring(1))
                            : "".concat(side, "-").concat(insetValue);
                    });
                }), zIndex: Object.keys(_this._theme.zIndex).flatMap(function (zIndexValue) {
                    return zIndexValue.startsWith('-') ? "-z-".concat(zIndexValue.substring(1)) : "z-".concat(zIndexValue);
        ...
        this.borders = function () {
            return tslib_1.__assign(tslib_1.__assign({}, non_configurable_1.nonConfigurableClassNames.borders), { 
                ...
                borderColor: _this.generateClassesWithColors('borderColor'), borderOpacity: _this.getGeneratedClassesWithOpacities().borderOpacities, borderRadius: Object.keys(_this._theme.borderRadius).flatMap(function (radius) {
                    ...
                    return sides.map(function (side) { return "rounded-".concat(side, "-").concat(radius); }).concat("rounded-".concat(radius));
                }), borderWidth: Object.keys(_this._theme.borderWidth).flatMap(function (width) {
                    var sides = ['t', 'r', 'b', 'l', 'x', 'y'];
                    return sides.map(function (side) { return "border-".concat(side, "-").concat(width); }).concat("border-".concat(width));
                }), 
                ...
                divideWidth: Object.keys(lodash_1.default.isEmpty(_this._theme.divideWidth) ? _this._theme.borderWidth : _this._theme.divideWidth)
                    .concat('reverse')
                    .flatMap(function (width) { return ['x', 'y'].map(function (axis) { return "divide-".concat(axis, "-").concat(width); }); }), 
        ...
        this.tables = function () {
            return tslib_1.__assign(tslib_1.__assign({}, non_configurable_1.nonConfigurableClassNames.tables), { borderSpacing: ['', '-x', '-y'].flatMap(function (side) {
                    return Object.keys(lodash_1.default.isEmpty(_this._theme.borderSpacing) ? _this._theme.spacing : _this._theme.borderSpacing).map(function (value) { return "border-spacing".concat(side, "-").concat(value); });
                }) });
        };
        this.effects = function () {
            return tslib_1.__assign(tslib_1.__assign({}, non_configurable_1.nonConfigurableClassNames.effects), { boxShadow: Object.keys(_this._theme.boxShadow).map(function (key) { return "shadow-".concat(key); }), boxShadowColor: _this.generateClassesWithColors('boxShadowColor'), opacity: _this.getGeneratedClassesWithOpacities().opacities });
        };
        ...
        this.transforms = function () {
            return tslib_1.__assign(tslib_1.__assign({}, non_configurable_1.nonConfigurableClassNames.transforms), { scale: ['', 'x-', 'y-'].flatMap(function (x) {
                    ...
                    return value.startsWith('-') ? '-rotate-' + value.slice(1) : "rotate-".concat(value);
                }), 
                ...
                translate: ['x', 'y'].flatMap(function (side) {
                    return Object.keys(lodash_1.default.isEmpty(_this._theme.translate) ? _this._theme.spacing : _this._theme.translate).map(function (value) {
                        return value.startsWith('-')
                            ? "-translate-".concat(side, "-").concat(value.slice(1))
                            : "translate-".concat(side, "-").concat(value);
                    });
                }), skew: ['x', 'y'].flatMap(function (side) {
                    return Object.keys(_this._theme.skew).map(function (value) {
                        return value.startsWith('-') ? "-skew-".concat(side, "-").concat(value.substring(1)) : "skew-".concat(side, "-").concat(value);
                    });
        ...
        this.interactivity = function () {
            ...
            return tslib_1.__assign(tslib_1.__assign({}, non_configurable_1.nonConfigurableClassNames.interactivity), { cursor: Object.keys(_this._theme.cursor).map(function (x) { return 'cursor-' + x; }), caretColor: _this.generateClassesWithColors('caretColor'), willChange: Object.keys(_this._theme.willChange).map(function (x) { return 'will-change-' + x; }), accentColor: _this.generateClassesWithColors('accentColor'), scrollPadding: sides.flatMap(function (side) {
                    return Object.keys(_this._theme.scrollPadding).map(function (value) { return "scroll-p".concat(side, "-").concat(value); });
                }), scrollMargin: sides.flatMap(function (side) {
                    return Object.keys(_this._theme.scrollMargin).map(function (value) { return "scroll-m".concat(side, "-").concat(value); });
                }) });
        };
        this.SVG = function () {
        ...
        this.flexBox = function () {
            return tslib_1.__assign(tslib_1.__assign({}, non_configurable_1.nonConfigurableClassNames.flexBox), { flexBasis: Object.keys(_this._theme.flexBasis).map(function (x) { return "basis-".concat(x); }), flexGrow: Object.keys(_this._theme.flexGrow).map(function (x) { return "grow-".concat(x); }), flexShrink: Object.keys(_this._theme.flexShrink).map(function (x) { return "shrink-".concat(x); }), order: Object.keys(_this._theme.order).map(function (x) { return "order-".concat(x); }) });
        };
        this.grid = function () {
            return tslib_1.__assign(tslib_1.__assign({}, non_configurable_1.nonConfigurableClassNames.grid), { gridTemplateColumns: Object.keys(_this._theme.gridTemplateColumns).map(function (key) { return "grid-cols-".concat(key); }), gridAutoColumns: Object.keys(_this._theme.gridAutoColumns).map(function (key) { return "auto-cols-".concat(key); }), gridColumn: Object.keys(_this._theme.gridColumn).map(function (key) { return "col-".concat(key); }), gridColumnStart: Object.keys(_this._theme.gridColumnStart).map(function (key) { return "col-start-".concat(key); }), gridColumnEnd: Object.keys(_this._theme.gridColumnEnd).map(function (key) { return "col-end-".concat(key); }), gridTemplateRows: Object.keys(_this._theme.gridTemplateRows).map(function (key) { return "grid-rows-".concat(key); }), gridAutoRows: Object.keys(_this._theme.gridAutoRows).map(function (key) { return "auto-rows-".concat(key); }), gridRow: Object.keys(_this._theme.gridRow).map(function (key) { return "row-".concat(key); }), gridRowStart: Object.keys(_this._theme.gridRowStart).map(function (key) { return "row-start-".concat(key); }), gridRowEnd: Object.keys(_this._theme.gridRowEnd).map(function (key) { return "row-end-".concat(key); }), gap: ['gap-', 'gap-y-', 'gap-x-'].flatMap(function (x) {
            ...
            return {
                padding: sides.flatMap(function (side) {
                    return Object.keys(lodash_1.default.isEmpty(_this._theme.padding) ? _this._theme.spacing : _this._theme.padding).map(function (value) {
                        return value.startsWith('-') ? "-p".concat(side, "-").concat(value.slice(1)) : "p".concat(side, "-").concat(value);
                    });
                }),
                margin: sides.flatMap(function (side) {
                    return Object.keys(lodash_1.default.isEmpty(_this._theme.margin) ? _this._theme.spacing : _this._theme.margin).map(function (value) {
                        return value.startsWith('-') ? "-m".concat(side, "-").concat(value.slice(1)) : "m".concat(side, "-").concat(value);
                    });
                }),
                space: ['x', 'y'].flatMap(function (axis) {
                    return Object.keys(lodash_1.default.isEmpty(_this._theme.space) ? _this._theme.spacing : _this._theme.space)
                        ...
                        if (key.startsWith('-')) {
                            key = key.slice(1);
                            return '-space-' + axis + "-".concat(key);
                        }
                        else {
                            return "space-".concat(axis, "-").concat(key);
                        }
                    });
                }),
            };
            ...
            var _loop_1 = function (regularClassGroupKey) {
                Object.keys(_this._generatedRegularClassnames).map(function (key) {
                    ...
                    if (lodash_1.default.has(_this._generatedRegularClassnames[key], regularClassGroupKey)) {
                        ...
                        var generatedClassGroup = lodash_1.default.get(_this._generatedRegularClassnames, "".concat(key, ".").concat(regularClassGroupKey));
            ...
            var classnamesWithColors = propertyKeys
                ...
                if (typeof colorValue === 'object' && colorValue !== null) {
                    ...
                    return Object.keys(colorValue).flatMap(function (shade) {
                        if (utilName === 'border') {
                            return ['', 't', 'r', 'b', 'l', 'x', 'y'].map(function (side) { return "".concat(utilName, "-").concat(side.length > 0 ? side + '-' : '').concat(colorName, "-").concat(shade); });
                        }
                        else {
                            return "".concat(utilName, "-").concat(colorName, "-").concat(shade);
                        }
                    });
                }
                // Otherwise...
                    ...
                    if (utilName === 'border') {
                        return ['', 't', 'r', 'b', 'l'].map(function (side) { return "".concat(utilName, "-").concat(side.length > 0 ? side + '-' : '').concat(colorName); });
                    }
                    else {
                        return "".concat(utilName, "-").concat(colorName);
                    }
                }
            })
                .filter(Boolean);
        ...
        this.getGeneratedClassesWithOpacities = function () {
            ...
            var getOpacity = function (themePropertyName, outputNamePrefix) {
                ...
                return Object.keys(generatedOpacities).map(function (opacity) { return "".concat(outputNamePrefix, "-opacity-").concat(opacity); });
            };
            ...
            return {
                opacities: Object.keys(allOpacities).map(function (opacity) { return "opacity-".concat(opacity); }),
