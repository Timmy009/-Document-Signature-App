...
export declare type Grouping = Record<TGroupingCategoryItem, string[]>;
...
declare type TBordersCategoryItem = 'borderColor' | 'borderOpacity' | 'borderStyle' | 'borderWidth' | 'borderRadius' | 'divideWidth' | 'divideOpacity' | 'divideColor' | 'divideStyle' | 'ringColor' | 'ringOpacity' | 'ringOffsetColor' | 'ringOffsetWidth' | 'ringWidth' | 'outlineWidth' | 'outlineOffset' | 'outlineColor';
declare type TEffectsCategoryItem = 'boxShadow' | 'boxShadowColor' | 'opacity' | 'mixBlendMode' | 'backgroundBlendMode';
...
declare type TFlexBoxCategoryItem = 'flexBasis' | 'flexDirection' | 'flexWrap' | 'alignItems' | 'alignContent' | 'alignSelf' | 'placeContent' | 'placeItems' | 'placeSelf' | 'justifyContent' | 'justifyItems' | 'justifySelf' | 'flex' | 'flexGrow' | 'flexShrink' | 'order';
...
declare type TGroupingCategoryItem = 'group' | 'peer';
declare type TInteractivityCategoryItem = 'appearance' | 'cursor' | 'pointerEvents' | 'resize' | 'userSelect' | 'caretColor' | 'willChange' | 'accentColor' | 'scrollSnap' | 'scrollMargin' | 'scrollPadding' | 'scrollBehavior' | 'touchAction';
declare type TLayoutCategoryItem = 'display' | 'boxDecorationBreak' | 'boxSizing' | 'container' | 'float' | 'clear' | 'isolation' | 'objectFit' | 'objectPosition' | 'overflow' | 'overscrollBehavior' | 'position' | 'inset' | 'visibility' | 'zIndex' | 'aspectRatio' | 'columns' | 'breakBefore' | 'breakInside' | 'breakAfter';
...
declare type TTablesCategoryItem = 'borderCollapse' | 'tableLayout' | 'borderSpacing';
...
declare type TTypographyCategoryItem = 'fontFamily' | 'fontSize' | 'fontSmoothing' | 'fontStyle' | 'fontWeight' | 'fontVariantNumeric' | 'letterSpacing' | 'lineHeight' | 'listStyleType' | 'listStylePosition' | 'placeholderColor' | 'placeholderOpacity' | 'textAlign' | 'textColor' | 'textDecoration' | 'textOpacity' | 'textTransform' | 'verticalAlign' | 'whitespace' | 'wordBreak' | 'content' | 'textIndent' | 'textDecorationColor' | 'textDecorationStyle' | 'textDecorationThickness' | 'textUnderlineOffset';
export {};
