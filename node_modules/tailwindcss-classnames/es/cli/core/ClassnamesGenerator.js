...
var ClassnamesGenerator = /** @class */ (function () {
    ...
    function ClassnamesGenerator(parser) {
        ...
        this.tables = function () {
            return __assign(__assign({}, nonConfigurableClassNames.tables), { borderSpacing: ['', '-x', '-y'].flatMap(function (side) {
                    return Object.keys(_.isEmpty(_this._theme.borderSpacing) ? _this._theme.spacing : _this._theme.borderSpacing).map(function (value) { return "border-spacing".concat(side, "-").concat(value); });
                }) });
        };
        this.effects = function () {
            return __assign(__assign({}, nonConfigurableClassNames.effects), { boxShadow: Object.keys(_this._theme.boxShadow).map(function (key) { return "shadow-".concat(key); }), boxShadowColor: _this.generateClassesWithColors('boxShadowColor'), opacity: _this.getGeneratedClassesWithOpacities().opacities });
        };
        ...
        this.flexBox = function () {
            return __assign(__assign({}, nonConfigurableClassNames.flexBox), { flexBasis: Object.keys(_this._theme.flexBasis).map(function (x) { return "basis-".concat(x); }), flexGrow: Object.keys(_this._theme.flexGrow).map(function (x) { return "grow-".concat(x); }), flexShrink: Object.keys(_this._theme.flexShrink).map(function (x) { return "shrink-".concat(x); }), order: Object.keys(_this._theme.order).map(function (x) { return "order-".concat(x); }) });
        };
        this.grid = function () {
            ...
            var _loop_1 = function (regularClassGroupKey) {
                Object.keys(_this._generatedRegularClassnames).map(function (key) {
                    ...
                    if (_.has(_this._generatedRegularClassnames[key], regularClassGroupKey)) {
                        ...
                        var generatedClassGroup = _.get(_this._generatedRegularClassnames, "".concat(key, ".").concat(regularClassGroupKey));
